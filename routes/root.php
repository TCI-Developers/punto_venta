...
Route::get('/catalogo-matriz-status', 'Admin\RootController@catalogStatus')->name('catalogoMatriz.status')->middleware('permission:empresa,punto_venta,auth');
Route::post('/catalogo-matriz-sync-ajax', 'Admin\RootController@catalogSyncAjax')->name('catalogoMatriz.syncAjax')->middleware('permission:empresa,punto_venta,auth');
