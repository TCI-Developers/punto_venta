    ...
    <div class="card card-primary">
        ...
        <div class="card-body table-responsive">
            <div class="form-group">
                ...
                <a class="btn btn-success" href="{{route('devoluciones.create', 'sale')}}"
            ...
            <table class="table table-striped table-bordered datatable">
                ...
                <tbody>
                    @forelse($devoluciones as $index => $item)
                       <tr>
                           <td class="text-center">{{$item->fecha_devolucion}} {{$item->sale_id}}</td>
                           <td class="text-center">{{$item->getProduct->code_product}}</td>
                    ...
                    @empty
                    <tr><td colspan="5" class="table-warning text-center">Sin devoluciones.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
