      ...
      @csrf
        <input type="hidden" name="id">
          ...
          <div class="modal-footer">
              ...
              <a href="{{route('sale.index')}}" class="btn btn-light text-dark"><img src="{{asset('icons/cancel.svg')}}" alt="icon cancel" width="23">&nbsp;Cancelar</a>
              <button type="submit" class="btn btn-primary text-white" id="btnAddEdit"><img src="{{asset('icons/save.svg')}}" alt="icon save" width="23">&nbsp;Cerrar turno</button>
          </div>
      </form>
      @else
      <div class="modal-body">
        ...
        <div class="modal-footer">
            <a href="{{route('sale.index')}}" class="btn btn-light text-dark"><img src="{{asset('icons/cancel.svg')}}" alt="icon cancel" width="23">&nbsp;Regresar</a>
        </div>
      @endif
    </div>
  </div>
