    ...
    <div class="modal-content">
      ...
      @csrf
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary text_color" onClick="btnCancel()"><img class="icon_img" src="{{asset('icons/cancel.svg')}}" alt="icon cancel">Cancelar</button>
            <button type="submit" class="btn btn-primary text_color" id="btnAddEdit"><img class="icon_img" src="{{asset('icons/save.svg')}}" alt="icon save"> <span class="title">Agregar</span></button>
        </div>
      </form>
    </div>
  </div>
