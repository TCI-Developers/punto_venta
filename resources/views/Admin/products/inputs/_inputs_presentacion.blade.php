...
<label for="precio_mayoreo" class="col-lg-4 col-md-4 col-sm-12 presentation">Precio Mayoreo* <br>
    <input type="number" name="precio_mayoreo" id="precio_mayoreo" class="form-control inputModal" step="0.01" value="{{$product->precio_mayoreo}}" onchange="precioMayoreo(this)">
</label>
