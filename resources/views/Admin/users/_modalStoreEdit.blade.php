<!-- Modal -->
<div class="modal fade" id="users" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="usersLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                    <div class="row">
                        <label for="name" class="col-lg-12 col-md-12 col-sm-12">Nombre
                            <input type="text" name="name" id="name" class="form-control inputs" placeholder="Nombre Sucursal" required>
                        </label>
                        ...
                        <label for="" class="col-lg-12 col-md-12 col-sm-12" id="switch_pass" style="display:none;">
